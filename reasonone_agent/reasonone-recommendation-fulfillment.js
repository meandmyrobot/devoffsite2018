...
/**
 * Constructor for ReasonOneRecommendationFulfillment object
 * Handles the fulfillment of the ReasonOne recommendation intent
 *
 * @param {Object} assistant Instance of 'actions-on-google' assistant.
 */
const ReasonOneRecommendationFulfillment = class {
...
module.exports = ReasonOneRecommendationFulfillment;